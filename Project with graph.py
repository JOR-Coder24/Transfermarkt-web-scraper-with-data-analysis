...
# Define URL
page = "https://www.transfermarkt.co.uk/manchester-united/rekordspieler/verein/985"
...
final_df.to_excel("Man_Utd_records.xlsx", index=False)
...
if graphplot=="y":
    ...
    plt.xlabel('Player')
    plt.ylabel('Count')
    plt.title('Manchester United Players\' Appearances, Goals, and Assists')
